        ...
        <div class="row">
            ...
            <div class="col-1">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#tools" aria-controls="tools" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon tools-font-size text-nowrap">展开</span>
                </button>
                <div class="collapse navbar-collapse position-absolute" id="tools">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <div class="row tools-font-size">
                            ...
                            <%
                                String mesege= (String) request.getAttribute("Appellation");
                                if(mesege==null||mesege.length()==0){
                            %>
                            ...
                            %>
                            <input class="col-9 text-nowrap" id="appellation" readonly="readonly" value="<%=mesege%>">
                            <%
                                }
                            %>
